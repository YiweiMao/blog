...
![](../images/2021-01-05-LED_clock_files/rainbow_time.png "Figure 1: The final product showing the time."){:width="100%"}
...
![](../images/2021-01-05-LED_clock_files/ball_bag.png "Figure 2: Bag of cheap ping pong balls."){:width="40%"}
...
![](../images/2021-01-05-LED_clock_files/jig.png "Figure 3: Jig to slice each ping pong ball along the visible seam."){:width="50%"}
...
![](../images/2021-01-05-LED_clock_files/glued.png "Figure 4: Used hot glue to stick halves together."){:width="40%"}
...
![](../images/2021-01-05-LED_clock_files/fixed_leds.png "Figure 5: Cut strips of WS2128B LEDs wired together."){:width="100%"}
...
![](../images/2021-01-05-LED_clock_files/frame.png "Figure 6: Ping pong ball halves aligned to the LED strips."){:width="100%"}
...
![](../images/2021-01-05-LED_clock_files/rainbow_test.png "Figure 7: Test for light leakage."){:width="70%"}
...
![](../images/2021-01-05-LED_clock_files/led_circuit.png "Figure 8: Orientation of LED strips."){:width="100%"}
![](../images/2021-01-05-LED_clock_files/balls.png "Figure 9: Internal LED index for each ping pong ball."){:width="100%"}
...
![](../images/2021-01-05-LED_clock_files/rainbow_bg.png "Figure 11: Rainbow background."){:width="70%"}
...
![](../images/2021-01-05-LED_clock_files/thunder.gif "Figure 12: Storm animation."){:width="70%"}
...
![](../images/2021-01-05-LED_clock_files/campfire.png "Figure 13: Campfire animation."){:width="70%"}
...
![](../images/2021-01-05-LED_clock_files/fireworks.gif "Figure 14: Fireworks animation. Please excuse my shaky hands."){:width="70%"}
