...
My code can be found at [repo link](https://github.com/YiweiMao/pingPongClock).
...
each ball goes into a jig to hold it in place while I used an X-acto knife to slice along the seam. If you don't slice along the seam, you can see the seam when you shine the LED behind it! This is the most tedious part and took me a whole day.
...
![]({{site.baseurl}}/images/2021-01-05-LED_clock_files/fireworks.gif "Figure 14: Fireworks animation."){:width="70%"}
